...
public class WebserviceBasics {
	 ...
	 * REST is stateless and is fast compared to SOAP.
	 ...
	 * POST is used to create and update data in the server.
	 * GET is used to get data from the server.
	 * PUT is used to create data in the server.
	 ...
	 * For testing use : https://jsonplaceholder.typicode.com/ and below are the api's that is offers:
	 * /posts	100 posts

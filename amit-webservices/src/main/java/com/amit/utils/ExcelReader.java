...
public class ExcelReader {
	...
	public Object[][] getDataFromSheet(String sheetName, String ExcelName) {
		...
		try {
			...
			for (int i = 1; i < totalRow; i++) {
				...
				for (int j = 0; j < totalColumn; j++) {
					...
					// If cell of type Number , then this if condition will work
						...
						dataSets[i - 1][j] = (int)cell.getNumericCellValue();
			...
			System.out.println("Exception in reading xls file" + e.getMessage());
			e.printStackTrace();
		}
		return dataSets;
	}
